...
<div class="header_section">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="text-align: center">
        <div class="logo" style="margin-right: 40px;"><a href="/lawhome"><img src="{{asset('asset/images/HBSLaw-New-Logo.png')}}"></a></div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" href="/lawhome">HOME</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/lawabout">ABOUT US</a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/lawannoucement">ANNOUNCEMENT</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/lawcontact">CONTACT US</a>
            </li>
          </ul>
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i><img src="{{asset('asset/images/icon.png')}}" alt="" width="40" height="40"></i>
                </a>
