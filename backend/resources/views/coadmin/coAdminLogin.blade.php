...
<head>
  ...
  <title>Co-Admin Login Form</title>
  <style>
    .container {
      max-width: 400px;
      margin: 0 auto;
...
<body>
  <div class="container">
    <h1>Co-Admin Login Form</h1>
    <form action="{{ route('logincoAdmin') }}" method="post">
    @if(session('success'))
    ...
    <div class="register-link">
      Don't have an account? <a href="/coAdminRegister">Register here</a>
    </div>
  </div>
</body>
</html>
