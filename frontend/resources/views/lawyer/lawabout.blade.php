      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="col-md-4">
            <h2>Our Expertise</h2>
            <ul>
                <li><a href="{{ route('aircraft-leasing') }}">○ AIRCRAFT LEASING & PURCHASE</a></li>
                <li><a href="{{ route('banking-finance') }}">○ BANKING & FINANCE</a></li>
                <li><a href="{{ route('construction-realestate') }}">○ CONSTRUCTION & REAL ESTATE DEVELOPEMENT</a></li>
                <li><a href="{{ route('custom-tax') }}">○ CUSTOMS AND TAX</a></li>
                <li><a href="{{ route('dispute-resolution') }}">○ DISPUTE RESOLUTION AND LITIGATION</a></li>
            </ul>
          </div>
      </div>
    </div>
