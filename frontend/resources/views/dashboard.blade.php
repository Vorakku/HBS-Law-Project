...
@include('layout.navlawyer')
  ...
  <div class="container1">
    ...
    {{-- <table>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="{{ url('/logoutLawyer') }}" class="logout-button">Logout</a>
          </div>
        </td>
      </tr>
    </table> --}}
    ...
    <table>
        <tr>
          <th class="twenty-five">Field</th>
          <th class="Seventy-five">Data</th>
        </tr>
        <tr>
          <td>First Name</td>
          <td>{{ $data1->first_name }}</td>
        ...
        <tr>
          ...
          <td>
            <div class="actions">
              <a href="{{ url('/lawyeredit/' . $data1->id) }}" class="edit-button">Edit Profile</a>
              {{-- <a href="{{ url('/logoutLawyer') }}" class="logout-button">Logout</a> --}}
            </div>
          </td>
        </tr>
