...
class lawyerController extends Controller
{
    ...
    public function update1(Request $request)
        ...
        public function showLawyer(Request $request){ //declare model
            ...
            if($search != "")
            {
                $law = Lawyers::where('first_name', 'Like', '%' .$request->search.'%')->orwhere('last_name', 'Like', '%' .$request->search.'%')->orwhere('email', 'Like', '%' .$request->search.'%')->orwhere('date_of_birth', 'Like', '%' .$request->search.'%')
        ...
        public function showLawyer1(Request $request){ //declare model
            $search = $request['search']??"";
            if($search != "")
            {
                $law = Lawyers::where('first_name', 'Like', '%' .$request->search.'%')->orwhere('last_name', 'Like', '%' .$request->search.'%')->orwhere('email', 'Like', '%' .$request->search.'%')->orwhere('date_of_birth', 'Like', '%' .$request->search.'%')
