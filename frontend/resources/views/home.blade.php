...
{{-- <script src="{{ asset('js/search.js') }}" data-search-url="{{ route('search') }}"></script> --}}
            ...
            <div class="col-md-8">
                <div class="search">
                    ...
                    <form action="{{ route('search') }}" method="GET">
                        @csrf
                        <input type="text" name="query"id="searchInput" class="form-control" placeholder="Search lawyer" oninput="search()">
                    ...
                    <div class="dropdown-menu" id="dropdownMenu" aria-labelledby="navbarDropdown">
                        ...
                        <form action="/search">
                            <input name="query" type="text" class="form-control" placeholder="Search Expertises">
